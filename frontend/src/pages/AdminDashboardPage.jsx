  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-3 bg-white/70 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/50 dark:border-slate-700/50 rounded-xl p-6 shadow-lg transition-shadow duration-[250ms] hover:shadow-xl">
        ...
        <div className="lg:col-span-4 bg-white/70 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/50 dark:border-slate-700/50 rounded-xl p-6 shadow-lg transition-shadow duration-[250ms] hover:shadow-xl">
        ...
        <div className="lg:col-span-5 bg-white/70 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/50 dark:border-slate-700/50 rounded-xl p-6 shadow-lg transition-shadow duration-[250ms] hover:shadow-xl">
